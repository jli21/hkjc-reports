...
document says how it was derived, validated, profiled, and three times nearly mis-concluded --- the third time in this report's own statistics rather than in the model.
...
\textbf{The answer, up front.} \bad{No.} Direct probit training beats both baselines on
the mean, but neither margin survives a test across test years: $t=-1.40$ against the production
booster and $t=-0.46$ against the link-only probit, on $6/11$ years favourable. Essentially the
whole gain belongs to the probit \emph{link}, which the repository already has and which costs no
fitting at all. The recommendation is to keep the softmax booster.
...
%======================================================================
\section{Tuning the architecture for its own objective}
%======================================================================
